...
'''Script to test aLTT with different betting strategies'''
...
for CONTROL in ['FDR','FWER']:	#Type of error control
	for eps in [0.25]:			#epsilon parameter for epsilon-greegy exploration
		for exp_pol in ['GREEDY_E']:	#Type of Exploration
			for bet_pol in ['AGRAPA']:	#Betting strategy to test
				for delta in np.linspace(0.05,0.95,19): 	#Error Tolerance Level to Test
